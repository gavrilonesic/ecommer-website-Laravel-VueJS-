...
class Setting extends Model
{
     ...
     * @return array
     */
    public static function getValidationRules($page = null)
    {
        return self::getDefinedSettingFields($page)->pluck('rules', 'name')
            ->reject(function ($val) {
                return is_null($val);
            })->toArray();
    }
     ...
     * @return Collection
     */
    private static function getDefinedSettingFields($page = null)
    {
        return collect($page ? [config("setting_fields.$page")] : config("setting_fields"))->pluck('elements')->flatten(1);
    }

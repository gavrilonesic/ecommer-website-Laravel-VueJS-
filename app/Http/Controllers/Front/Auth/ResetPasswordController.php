...
class ResetPasswordController extends FrontController
{
    ...
    protected function resetPassword($user, $password)
    {
        ...
        Email::sendEmail('customer.reset_password', $placeHolders, $user->email ?? '');

        $this->guard()->login($user);

        Session::flash('success', __('messages.record_updated_success_msg', ['name' => __('messages.reset_password')]));
    }

...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
           {!! Breadcrumbs::render('EditBlogCategory') !!}
        </div>
        {!! Form::model($blogcategory, ['name' => 'edit-blogcategory-form', 'method' => 'PUT', 'id' => 'edit-blogcategory-form', 'files' => true]) !!}
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class="col-md-12">     <div class="form-group">
                                    <div class="input-file input-file-image">
                                        ...
                                        {!! Form::file('image', ['id' => 'image', 'class' => 'form-control form-control-file', 'accept' => 'image/*']) !!}
                                         ...
                                         @if($blogcategory->getMedia('blogcategory')->first())
                                            <i class="icon-close remove-image"  data-toggle="tooltip" data-placement="top" title="Remove Image" data-type="blogcategory"></i>
                                        @endif
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group" id="brand">
                                       ...
                                       {!! Form::select('status', ['1' => 'Active', '0' => 'Inactive'], $blogcategory->status, ['id' => 'status', 'class' => 'form-control form-control']) !!}
...
{!! JsValidator::formRequest('App\Http\Requests\BlogCategoryRequest', '#edit-blogcategory-form') !!}

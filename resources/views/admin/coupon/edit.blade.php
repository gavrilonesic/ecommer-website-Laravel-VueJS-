...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">{{__('messages.edit_coupon')}}</h4>
        </div>
        {!! Form::model($coupon, ['name' => 'edit-coupon-form', 'method' => 'PUT', 'id' => 'edit-coupon-form']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <span class="required-label">*</span>
                                        {!! Form::text('code', null, ['id' => 'code', 'placeholder' => __('messages.enter_coupon_code'), 'class' => 'form-control','disabled' => 'disabled']) !!}
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio">
                                            {!! Form::radio('price_type', 'flat_price', null, ['id' => 'flatprice', 'class' => 'custom-control-input','disabled' => 'disabled']) !!} 
                                            <label class="custom-control-label" for="flatprice">{{__('messages.flat_price')}}</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            {!! Form::radio('price_type', 'percentage', null, ['id' => 'percentage', 'placeholder' => __('messages.enter_coupon_name'), 'class' => 'custom-control-input','disabled' => 'disabled']) !!}
                                ...
                                <div class="col-md-6 col-lg-6">
                                   <div class="show-hide form-group">
                                        <div class="price">
                                            ...
                                            <span class="required-label">*</span>
                                            {!! Form::text('percent_price', null, ['id' => 'price', 'placeholder' => __('messages.enter_price'), 'class' => 'form-control','disabled' => 'disabled']) !!}
                                        </div>
                                        <div class="percentage">
                                            <label for="name">{{__('messages.percentage')}}</label>
                                            <span class="required-label">*</span>
                                            {!! Form::text('percent_price', null, ['id' => 'percentage_value', 'placeholder' => __('messages.enter_percentage'), 'class' => 'form-control', 'max_length' => '3','disabled' => 'disabled']) !!}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group d-flex flex-row">
                                        <label for="order_coupon"><input id="order_coupon" type="radio" name="coupon_type" value="order_coupon" @if ($coupon->products->isEmpty()) checked @endif> &nbsp;Order Coupon</label>
                                        &nbsp;
                                        &nbsp;
                                        <label for="product_coupon"><input id="product_coupon" type="radio" name="coupon_type" value="product_coupon" @if (! $coupon->products->isEmpty()) checked @endif> &nbsp;Product Coupon</label>
                                    </div>

                                    <div class="form-group" @if ($coupon->products->isEmpty()) style="display: none;" @endif>
                                        <label for="page_title">{{__('messages.coupon_products')}}</label>
                                        {!! Form::textarea('products_list', implode(', ', $coupon->products->pluck('sku')->toArray()), ['id' => 'coupon_products', 'placeholder' => __('messages.coupon_products'), 'class' => 'form-control']) !!}
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('status', ['1' => 'Active','0' => 'Inactive'], $coupon->status, ['id' => 'status', 'class' => 'form-control form-control']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
...
@endsection
@section('script')
{!! JsValidator::formRequest('App\Http\Requests\CouponRequest', '#edit-coupon-form') !!}

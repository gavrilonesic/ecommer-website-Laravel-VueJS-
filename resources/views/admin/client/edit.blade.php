...
<div class="content">
    <div class="page-inner">
        ...
        {!! Form::model($client, ['name' => 'edit-client-form', 'method' => 'PUT', 'id' => 'edit-client-form', 'files' => true]) !!}
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                                ...
                                <div class="col-12 mt-4">
                                    <div class="form-group">
                                        <div class="input-file input-file-image">
                                            <img class="img-upload-preview" width="150" src="{{$client->getMedia('clients')->first() ? $client->getFirstMediaUrl('clients') : asset('images/150x150.png')}}" alt="preview">
                                            ...
                                            <label for="image" class="label-input-file float-left">
                                                ...
                                                <i class="icon-pencil" data-toggle="tooltip" data-placement="top" title="" data-original-title="Change Image"></i>
                                                </span>
...
@section('script')
{!! JsValidator::formRequest('App\Http\Requests\ClientRequest', '#edit-client-form') !!}
<script>

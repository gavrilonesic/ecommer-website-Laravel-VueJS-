...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            {!! Breadcrumbs::render('EditCmsPage') !!}
        </div>
        {!! Form::model($cmsPage, ['name' => 'edit-cms-page-form', 'method' => 'PUT', 'id' => 'edit-cms-page-form', 'files' => true]) !!}
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">    <div class="form-group">
                                        <div class="input-file input-file-image">
                                            ...
                                            @if($cmsPage->getMedia('cms_page')->first())
                                            <i class="icon-close remove-image"  data-toggle="tooltip" data-placement="top" title="Remove Image" data-type="cms_page"></i>
                                            @endif
...
{!! JsValidator::formRequest('App\Http\Requests\CmsPageRequest', '#edit-cms-page-form') !!}
<script>

...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
           {!! Breadcrumbs::render('AddBlog') !!}
        </div>
        {!! Form::open(['name' => 'add-blog-form', 'id' => 'add-blog-form', 'files' => true]) !!}
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group" id="cat">
                                        ...
                                        <span class="required-label">*</span>
                                        {!! Form::select('blog_category_id', $blogcategory, null, ['id' => 'blog_category_id', 'class' => 'form-control form-control']) !!}

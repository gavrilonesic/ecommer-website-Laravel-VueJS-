...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
           {!! Breadcrumbs::render('AddCarousel') !!}
        </div>
        {!! Form::open(['name' => 'add-carousel-form', 'id' => 'add-carousel-form', 'files' => true]) !!}
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-file input-file-image">
                                        ...
                                        {!! Form::hidden('imagebg_exists','null') !!}
...
@endsection
@section('script')
{!! JsValidator::formRequest('App\Http\Requests\CarouselRequest', '#add-carousel-form') !!}
@endsection
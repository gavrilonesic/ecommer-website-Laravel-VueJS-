...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            {!! Breadcrumbs::render('AddAdminUser') !!}
        </div>
        {!! Form::open(['name' => 'add-admin-user-form', 'id' => 'add-admin-user-form', 'files' => true]) !!}
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('role_id', config('constants.ROLES'), 1, ['id' => 'role_id', 'placeholder' => __('messages.select_role'), 'class' => 'select2 form-control']) !!}
...
@endsection
@section('script')
{!! JsValidator::formRequest('App\Http\Requests\UserRequest', '#add-admin-user-form') !!}

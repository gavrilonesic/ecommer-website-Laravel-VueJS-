...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
           {!! Breadcrumbs::render('EditReview') !!}
        </div>
        {!! Form::model($review, ['name' => 'edit-review-form', 'method' => 'PUT', 'id' => 'edit-review-form', 'files' => true]) !!}
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-lg-5">
                                        <div class="form-group" id="">
                                            ...
                                            {!! Form::select('product_id', $products,null, ['id' => 'products_select', 'class' => 'form-control select2']) !!}
                                        </div>
                                    </div>
                            </div>
...
@section('script')
{!! JsValidator::formRequest('App\Http\Requests\ReviewRequest', '#edit-review-form') !!}

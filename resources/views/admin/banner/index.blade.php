                            ...
                            <table class="display table table-head-bg-primary table-striped datatable-with-image">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($banner->show_on_page == 'display_in_all_page') All Pages
                                            @elseif($banner->show_on_page == 'home_page') Home Page
                                            @elseif($banner->show_on_page == 'for_specific_category') Category Page -{{$banner->category_name}}
                                            @elseif($banner->show_on_page == 'for_specific_brand') Brand - {{$banner->brand_name}} @else - @endif
                                        </td>
                                        <td>
                                            @if($banner->visibility == '0') No
                                            @elseif($banner->visibility == '1') Yes
                                            @else - @endif
                                        </td>
                                        <td>

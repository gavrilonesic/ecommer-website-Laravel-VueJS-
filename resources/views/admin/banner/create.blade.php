...
<div class="content">
    <div class="page-inner">
        ...
        {!! Form::open(['name' => 'add-banner-form', 'id' => 'add-banner-form', 'files' => true]) !!}
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio">
                                            {!! Form::radio('type', 0, true, ['id' => 'small-width', 'class' => 'custom-control-input']) !!} 
                                            <label class="custom-control-label" for="small-width">{{__('messages.small_width')}}</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            {!! Form::radio('type', 1, null, ['id' => 'full-width', 'class' => 'custom-control-input']) !!}
                         ...
                         <div class="row col-md-6" id="dates_section">
                                   <div class="form-group col-md-6 col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append date_start">
                                                <span class="input-group-text">
                                                    <i class="icon-calendar">
                                                        {!! Form::hidden('date_start', null, ['id' => 'date_start', 'placeholder' => __('messages.date_start'), 'class' => 'form-control']) !!}
                                                    </i>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6 col-lg-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append date_end">
                                                    <span class="input-group-text">
                                                        <i class="icon-calendar">
                                                            {!! Form::hidden('date_end', null, ['id' => 'date_end', 'placeholder' => __('messages.date_end'), 'class' => 'form-control']) !!}
                                                        </i>
                                                    </span>
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <label for="price_type">{{__('messages.visible_on_site')}}</label><br>
                                        ...
                                        {!! Form::checkbox('visibility', 1, true, ['id' => 'customCheck1', 'class' => 'form-control custom-control-input']) !!}
                                        <label class="custom-control-label" for="customCheck1">Yes, this banner should be visible on my web site</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@endsection
@section('script')
{!! JsValidator::formRequest('App\Http\Requests\BannerRequest', '#add-banner-form') !!}
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        jQuery('#date_start').datetimepicker({
         ...
         jQuery('#home_page').click();
         jQuery('#show_until_i_remove').click();

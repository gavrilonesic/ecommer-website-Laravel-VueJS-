...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            {!! Breadcrumbs::render('AddTestimonial') !!}
        </div>
        {!! Form::open(['name' => 'add-testimonial-form', 'id' => 'add-testimonial-form', 'files' => true]) !!}
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
...
{!! JsValidator::formRequest('App\Http\Requests\TestimonialRequest', '#add-testimonial-form') !!}
<script>
    $('.select2').select2({
        theme: "bootstrap"
    });

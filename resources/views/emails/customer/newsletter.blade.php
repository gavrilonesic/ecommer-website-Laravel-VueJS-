    ...
    <tr>
        <td bgcolor="#ffffff" style="padding: 40px 40px 0 40px; text-align: center; border-top:3px solid #393950;">
            ...
            <h1 style="margin: 0 0 5px 0; font-family: 'Montserrat', sans-serif;  font-size: 22px; line-height: 22px; color: #3eabe2; font-weight: 600; text-transform: uppercase">
                {{__('messages.signup_for_deals_confirmation')}}
            </h1>
            <p style="margin: 0 0 20px 0; font-family: 'Montserrat', sans-serif;  font-size: 16px; line-height: 20px; color: #666666; font-weight: 500;">
                ...
                <br>
                {{__('messages.thank_you_for_signup_for_deals')}}
            </p>
        </td>
    </tr>
    <tr>
        <td bgcolor="#ffffff" style="padding:20px 40px; text-align:left; ">
            <p
                ...
                This email confirms that you have been successfully SIGNUP for Deals with Email Id - [Customer Email]</p>
            <p
                style="font-size: 13px; color:#666666; font-weight:500; font-family: 'Montserrat', sans-serif; line-height: 16px;">
                You will get our Deals Newsletter on above mail. Avail our various offers on products and enjoy its benefits.</p>
        </td>
    </tr>
    <tr>
        <td bgcolor="#ffffff" style="padding:20px 40px; text-align:left; ">
    ...
    <tr>
     ...
     <tr>
        <td bgcolor="#ffffff" style="text-align:center; ">
            <p
                style="font-size: 13px; color:#666666; font-weight:500; font-family: 'Montserrat', sans-serif; line-height: 16px;">
                <a href="{{ setting('mail_chimp_unsubscribe_link') }}" target="_blank" style="font-size: 10px; color:#666666; font-weight:500; font-family: 'Montserrat', sans-serif; line-height: 16px; text-decoration:underline;">Unsubscribe</a></p>
        </td>
    </tr>
</table>
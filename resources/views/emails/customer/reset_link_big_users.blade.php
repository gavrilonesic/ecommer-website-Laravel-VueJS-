    ...
    <tr>
        <td bgcolor="#ffffff" style="padding: 40px 40px 0 40px; text-align: center; border-top:3px solid #393950;">
            ...
            <h1 style="margin: 0 0 5px 0; font-family: 'Montserrat', sans-serif;  font-size: 22px; line-height: 22px; color: #3eabe2; font-weight: 600; text-transform: uppercase">
                {{__('messages.reset_password_link')}}
            </h1>
            <p style="margin: 0 0 20px 0; font-family: 'Montserrat', sans-serif;  font-size: 16px; line-height: 20px; color: #666666; font-weight: 500;">
                <strong style="font-weight: 700">
                 ...
                 <br>
                 <br>
                We are moving to our new Website to enhance your experience. In order to manage your existing account on our new website,  it is required to reset your password!
                <br>
                <br>
                Please click the below link.
                <p bgcolor="#ffffff"
                    style="padding: 0px 40px 40px 40px; text-align: center; border-bottom:1px solid #f0f5f9">
                    <a href="[Reset Password Link]" style="display: inline-block; padding:10px 20px;  font-family: 'Montserrat', sans-serif;   color:#fff; background-color:#3eabe2; font-weight:600; font-size:16px; text-align:center; line-height:16px; text-decoration: none;">{{__('messages.click_link')}}</a>
                </p>
            </p>
        </td>
    </tr>

    ...
    <tr>
        <td bgcolor="#ffffff" style="padding: 40px 40px 0 40px; text-align: center; border-top:3px solid #393950;">
            ...
            <h1 style="margin: 0 0 5px 0; font-family: 'Montserrat', sans-serif;  font-size: 22px; line-height: 22px; color: #3eabe2; font-weight: 600; text-transform: uppercase">
                New order #[Order ID] is placed.
            </h1>
        </td>
    </tr>
    <tr>
        <td bgcolor="#ffffff" style="padding: 0px 40px 40px 40px; text-align: center; border-bottom:1px solid #f0f5f9">
            <a href="{{ url('/admin/orders') }}"
                style="display: inline-block; padding:10px 20px;  font-family: 'Montserrat', sans-serif;   color:#fff; background-color:#3eabe2; font-weight:600; font-size:16px; text-align:center; line-height:16px; text-decoration: none;">{{__('messages.view_order')}}</a>
        </td>
    </tr>
    <tr>
        <td bgcolor="#ffffff" style="padding:20px 40px; text-align:left; ">
            <p style="font-size: 13px; color:#666666; font-weight:500; font-family: 'Montserrat', sans-serif; line-height: 16px;">
                This email confirms that order #[Order ID] has been successfully placed by [Customer Name].</p><br/>
        </td>
    </tr>
    <tr>

      ...
      <div class="container">
         <div class="row">
           ...
           <div class="alert alert-info po-box"><strong>{{__('messages.we_are_unable_to_deliver_to_po_box_address')}}</strong>
                ...
                <div class="cross-btn">
                    <div class="">
                        {!! Form::model($customers, ['name' => 'update-customer-form', 'id' => 'update-customer-form', 'method' => 'PUT', 'files' => true]) !!}
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('first_name',$customers->first_name,['placeholder' => __('messages.enter_first_name'), 'class' => 'customer_address_required form-control ' . ($errors->has('first_name') ? 'is-invalid' : '')]) !!}
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('last_name', $customers->last_name,['placeholder' => __('messages.enter_last_name'), 'class' => "customer_address_required form-control " . ($errors->has('last_name') ? 'is-invalid' : '')]) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('address_name', $customers->address_name, ['placeholder' => __('messages.enter_company_name'), 'class' => "form-control "]) !!}
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('mobile_no', $customers->mobile_no, ['placeholder' => __('messages.enter_mobile_no'), 'class' => "form-control " . ($errors->has('mobile_no') ? 'is-invalid' : '')]) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('address_line_1', $customers->address_line_1, ['placeholder' => __('messages.enter_address_line_1'), 'class' => "customer_address_required form-control " . ($errors->has('address_line_1') ? 'is-invalid' : '')]) !!}
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('address_line_2', $customers->address_line_2,['placeholder' => __('messages.enter_address_line_2'), 'class' => "form-control " . ($errors->has('address_line_2') ? 'is-invalid' : '')]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('zip_code', $customers->zip_code, ['placeholder' => __('messages.enter_zip_code'), 'class' => "customer_address_required form-control " . ($errors->has('zip_code') ? 'is-invalid' : '')]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('address_type', config('constants.ADDRESS_TYPE'), $customers->address_type, ['id' => "address_type_",'class' => "customer_address_required select2 form-control " . ($errors->has('address_type') ? 'is-invalid' : '')]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <!-- {!! Form::radio('primary_address', 'Yes', false, ['id' => 'customCheck', 'class' => 'form-control custom-control-input primary_address']) !!}
                                    <label class="custom-control-label" for="customCheck">{{__('messages.yes')}}</label>

                                    {!! Form::radio('primary_address', 'No', false, ['id' => 'customCheck', 'class' => 'form-control custom-control-input primary_address']) !!}
                                    <label class="custom-control-label" for="customCheck">{{__('messages.no')}}</label> -->

                                    {{ Form::label('primary_address', 'Yes') }}
                                    {{ Form::radio('primary_address', '1', false, array('id'=>'primary_address')) }}

                                    {{ Form::label('primary_address', 'No') }}
                                    {{ Form::radio('primary_address', '0', false, array('id'=>'primary_address')) }}
...
@endsection
@section('script')
{!! JsValidator::formRequest('App\Http\Requests\AddressRequest', '#update-customer-form') !!}
<script type="text/javascript">
   var country_id = "{{ $customers->country_id }}";
   var state_id = "{{ $customers->state_id }}";
   $(document).ready(function(){
     @if (empty($customers->state_id))
        $(".state-asterisk").hide();
        $("#state_id").parent('div').find('input[type="text"]').show();
        $("#state_id").parent('div').find('input[type="text"]').removeAttr('disabled');
        $("#state_id").attr('disabled', true);
        $("#state_id").val('');
        $("#state_id").hide();
    @else
      $('#state_name').hide()
      getStateFirst(country_id,state_id);
    @endif
   ...
   function getStateFirst(countryId, stateId) {
    ...
    // function getCityFirst(stateId, cityId) {
    //     var $city = $("#city_id");
    //     $city.empty();
